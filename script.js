...
function formatDate(date) {
    ...
    const MONTHS = [
        "ledna", "února", "března", "dubna", "května", "června", "července", "srpna", "září", "října", "listopdu", "prosince"
    ];
...
// Formátování a zobrazení času a data
timeElement.textContent = formatTime(now);
dateElement.textContent = formatDate(now);

// Získání jména pro aktuální datum
const nameForDate = getNameForDate(now, names);
nameElement.textContent = "Dnes má svátek: " + nameForDate;